        ...
        <header className="relative flex justify-center w-full h-[532px]">
            ...
            <div>
                ...
                <div className='relative z-10 py-10 md:p-10 flex flex-col lg:flex-row items-center gap-3'>
                    <div className='relative flex items-center w-[348px]'>
                        <div className='bg-icon-search bg-no-repeat w-6 h-6 absolute left-0 ml-[14px]'></div>
                        <input className='w-full py-3 pl-[50px] pr-2 dark:bg-black' type="text" placeholder='Pesquise por nome' />
                    </div>
                    <div className='relative flex items-center  w-[348px]'>
                        ...
                        <input className='w-full py-3 pl-[50px] pr-2 dark:bg-black' type="text" placeholder='Selecione uma cidade' />
                    </div>
                   
                    <button className='uppercase bg-purple text-white px-8 py-3 rounded max-w-[348px] w-full lg:w-fit'>Buscar agora</button>
                </div>
            </div>
        </header>
    )
