    ...
    return (
        <header className="relative flex justify-center  w-full h-[532px]">
            <div className="absolute z-0 w-full h-full">
                <div className="absolute top-0 left-0 bg-illustration-1 w-[407px] h-[345px] bg-no-repeat"></div>
                <div className="absolute bottom-0 right-0 bg-illustration-2 w-[414px] h-[330px] bg-no-repeat"></div>
            </div>
            <div>
